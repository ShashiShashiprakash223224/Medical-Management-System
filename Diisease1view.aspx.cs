...
{
    public partial class Diisease1view : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "select * from  Disease where diseasename like'%'+@diseasename+'%'";
            ...
            if (TextBox1.Text == "")  
            {
                Label1.Text = "<span style='color:white'>Insert values</span>";
            }
